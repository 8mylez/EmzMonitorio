...
- Service- und Routen-Definitionen von XML auf PHP umgestellt (`services.php`, `routes.php`): Shopware 6.8 lädt XML-Konfiguration aus Plugins nicht mehr, die PHP-Dateien lädt Shopware seit 6.5.7. Registrierte Services und Routen sind unverändert.
